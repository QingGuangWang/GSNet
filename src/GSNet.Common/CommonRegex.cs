...
namespace GSNet.Common
{
    ...
    public static class CommonRegex
    {
        ...
        /// ISO 日期时间格式的 正则表达式
        /// </summary>
        public static Regex ISODateRegex = new Regex("^(-?(?:[1-9][0-9]*)?[0-9]{4})-(1[0-2]|0[1-9])-(3[01]|0[1-9]|[12][0-9])T(2[0-3]|[01][0-9]):([0-5][0-9]):([0-5][0-9])(\\.[0-9]+)?(Z|[+-](?:2[0-3]|[01][0-9]):{0,1}[0-5][0-9])?$");
        ...
        /// 匹配常见的标点符号
        /// </summary>
        public static readonly Regex PUNCTUATION = new Regex("[ \\[ \\] \\^ \\-_*×――(^)（^）$%~!@#$…&%￥—+=<>《》!！??？:：•`·、。，；,.;\"‘’“”-]", RegexOptions.Compiled);
